...
:: Android packaging
set AND_CERT_NAME="SlimeOnline"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\SlimeOnline.p12
...
set IOS_PROVISION=cert\SlimeOnline.mobileprovision
...
set APP_ID=air.SlimeOnline

:: Output packages
set DIST_PATH=dist
set DIST_NAME=SlimeOnline
